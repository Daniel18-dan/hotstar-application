pipeline{
    ...
    stages {
        ...
        stage('OWASP FS SCAN') {
            steps {
                dependencyCheck additionalArguments: '--scan ./ --disableYarnAudit --disableNodeAudit --nvdApiKey   f2a7c394-777e-47b4-a77b-9add35578e56', odcInstallation: 'DC'
        ...
        stage("TRIVY"){
            steps{
                sh "trivy image sarvjeet908/hotstar:latest > trivyimage.txt" 
            }
        }
